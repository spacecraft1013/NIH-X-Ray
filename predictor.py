...
parser.add_argument('--model', '-m', type=str,
                    help='Path to h5 model to use to predict image.')
parser.add_argument('--grayscale', '-g', type=bool,
                    help='Whether to read the image as grayscale, \
                          default is image default.')
...
activation_map_model = keras.models.Model(inputs=model.get_layer(1),
                                          outputs=model.get_layer(1))
